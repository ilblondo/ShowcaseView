...
public class ShowcaseView extends RelativeLayout implements View.OnClickListener, View.OnTouchListener
{
	...
	public boolean onTouch(View view, MotionEvent motionEvent)
	{
		...
		if (MotionEvent.ACTION_UP == motionEvent.getAction() && mOptions.hideOnClickOutside && distanceFromFocus > showcaseRadius)
		{
			this.hide();
			return true;
		}
	 ...
	 */
	private static ShowcaseView insertShowcaseViewInternal(Target target, Activity activity, String title, String detail, ConfigOptions options)
	{
		ShowcaseView sv = new ShowcaseView(activity);
		sv.setConfigOptions(options);
		if (sv.getConfigOptions().insert == INSERT_TO_DECOR)
	...
	private static ShowcaseView insertShowcaseViewInternal(Target target, Dialog dialog, String title, String detail, ConfigOptions options)
	{
	...
	public static ShowcaseView insertShowcaseViewInternal(Target target, Dialog dialog,Activity activity, String title, String detail, ConfigOptions options)
	{
		ShowcaseView sv = new ShowcaseView(dialog.getContext());
		sv.setConfigOptions(options);
		if (sv.getConfigOptions().insert == INSERT_TO_DECOR)
	...
	public static ShowcaseView insertShowcaseView(Target target, Dialog dialog,Activity activity, int title, int detail, ConfigOptions options)
	{
		return insertShowcaseViewInternal(target, dialog, activity.getString(title), activity.getString(detail), options);
	}
